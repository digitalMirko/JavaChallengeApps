package app14_number_of_days_in_month;

public class NumberOfDaysInMonth {

    /*  Challenge: Number of Days in a Month
        ...
        * isLeapYear(-1600); →  should return false since the parameter is not
          in the range (1-9999)
        ...
        * getDaysInMonth(2, 2020); → should return 29 since February has 29 days
           in a leap year and 2020 is a leap year.

        * getDaysInMonth(2, 2018); → should return 28 since February has 28 days if it's
           not a leap year and 2018 is not a leap year.
